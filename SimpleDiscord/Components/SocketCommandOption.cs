...
#nullable enable
    public class SocketCommandOption
    {
        ...
        public CommandOptionChoice[]? Choiches { get; internal set; }
        ...
        [JsonConstructor]
        public SocketCommandOption(int type, string name, Dictionary<string, string>? nameLocalizations, string description, Dictionary<string, string>? descriptionLocalizations, bool? required, CommandOptionChoice[]? choiches, SocketCommandOption[]? options, int? minLength, int? maxLength)
        {
            Type = type;
            Name = name;
